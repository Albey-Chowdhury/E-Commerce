...
@section('content')
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Update Category Elements</h1>
      <nav>
        <ol class="breadcrumb">
      ...
      <div class="row">
       {{-- Set Errors Masseges --}}
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Update Category Elements</h5>

              <!-- General Form Elements -->
              <form action="{{url('/catagory/update/'.$category->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-sm-5">
                      <img src="{{asset('images/'.$category->image)}}" height="200" width="200">
